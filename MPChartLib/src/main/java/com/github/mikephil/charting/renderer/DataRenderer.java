...
public abstract class DataRenderer extends Renderer {
    ...
    protected Paint mDrawTrianglePaint;

    protected Paint mDrawCirclePaint;
    ...
    public DataRenderer(ChartAnimator animator, ViewPortHandler viewPortHandler) {
        ...
        mDrawTrianglePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mDrawTrianglePaint.setColor(Color.WHITE);
        mDrawTrianglePaint.setStyle(Style.FILL);

        mDrawCirclePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mDrawCirclePaint.setColor(Color.rgb(240,240,240));
        mDrawCirclePaint.setStyle(Style.STROKE);
        mDrawCirclePaint.setStrokeWidth(40f);
    }
   ...
   /* public abstract void drawTriangle(Canvas c);
    public abstract void drawCircle(Canvas c);*/
    /**
