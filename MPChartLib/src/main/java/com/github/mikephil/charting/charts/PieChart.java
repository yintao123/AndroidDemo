...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    private int mPieChartItemIndex;
    ...
    public float getCenterX(){
        return mCircleBox.centerX();
    }

    public float getCenterY(){
        return mCircleBox.centerY();
    }
    ...
    public void setPieChartItemIndex(int index){
        mPieChartItemIndex = index;
    }

    public int getPieChartItemIndex(){
        return mPieChartItemIndex;
    }
