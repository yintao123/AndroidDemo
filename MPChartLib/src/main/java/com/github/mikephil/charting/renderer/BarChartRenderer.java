...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            DashPathEffect effect = set.getDashPathEffectHighlight();
            if (effect != null) {
            ...
            mHighlightLinePath.moveTo(mBarRect.centerX(), mViewPortHandler.getContentRect().bottom);
            mHighlightLinePath.lineTo(mBarRect.centerX(), 0);
