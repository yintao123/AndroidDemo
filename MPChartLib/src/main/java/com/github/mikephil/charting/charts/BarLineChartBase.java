...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected float mMinLeftOffset = 15f;
    /**
    ...
    public void calculateOffsets() {
        ...
        if (!mCustomViewPortEnabled) {
            ...
            mViewPortHandler.restrainViewPort(
                    Math.max(Math.max(minOffset, offsetLeft), mMinLeftOffset),
    ...
    public boolean isDragEnabled() {
        return mDragEnabled && (mDragXEnabled || mDragYEnabled);
    }
    ...
    public void setDragXEnabled(boolean mDragXEnabled) {
    ...
    public void setDragYEnabled(boolean mDragYEnabled) {
    ...
    public float getMinLeftOffset() {
        return mMinLeftOffset;
    }

    public void setMinLeftOffset(float mMinLeftOffset) {
        this.mMinLeftOffset = mMinLeftOffset;
    }
