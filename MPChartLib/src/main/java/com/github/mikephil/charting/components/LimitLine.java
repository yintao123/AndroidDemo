...
public class LimitLine extends ComponentBase {
    ...
    public enum LimitLabelPosition {
        LEFT_TOP, LEFT_BOTTOM, RIGHT_TOP, RIGHT_BOTTOM, LEFT_OUTER, RIGHT_OUTER, LEFT_INNER, RIGHT_INNER
    }

    private Drawable labelBackground;
    private float backgroundPaddingX;
    private float backgroundPaddingY;
    /**
    ...
    public float getBackgroundPaddingX() {
        return backgroundPaddingX;
    }

    public float getBackgroundPaddingY() {
        return backgroundPaddingY;
    }

    public void setBackgroundPadding(float backgroundPaddingX, float backgroundPaddingY) {
        this.backgroundPaddingX = backgroundPaddingX;
        this.backgroundPaddingY = backgroundPaddingY;
    }
    ...
    public void setLimit(float limit, String label)
    {
        mLimit = limit;
        mLabel = label;
    }
